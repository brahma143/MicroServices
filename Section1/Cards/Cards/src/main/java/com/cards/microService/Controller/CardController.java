package com.cards.microService.Controller;

import com.cards.microService.Contants.CardsConstants;
import com.cards.microService.DTO.CardDto;
import com.cards.microService.DTO.ErrorResponseDto;
import com.cards.microService.DTO.ResponseDto;
...
public class CardController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardDto> getCards(@RequestParam String mobileNumber){
       CardDto cardDto =cardService.fetchData(mobileNumber);
    ...
    public ResponseEntity<ResponseDto> deleteCard(@Valid  @RequestParam
                                                  @Pattern(regexp=("^$|[0-9]{10}"),message = "mobileNumber")
                                                  String mobileNumber){

         boolean isDeleted = cardService.dateleCard(mobileNumber);
        if(isDeleted){
